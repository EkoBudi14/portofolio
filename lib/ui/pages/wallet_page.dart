...
class WalletPage extends StatelessWidget {
  ...
  // ! METHODE UNTUK FUTURE BUILDER ATAU UNTUK MENAMPILKAN
  //  ! LIST CARD DARI TOP UP DAN HISTORI PEMBELIAN
  Column generateTransactionList(
      List<FlutixTransaction> transactions, double width) {
    // * INI UNTUK MENGURUTKAN CARDNYA DARI TANGGALNYA
...
// ! MEMBUAT CLIPPATH UNTUK CARDNYA
