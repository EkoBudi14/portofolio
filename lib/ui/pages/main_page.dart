...
class _MainPageState extends State<MainPage> {
  ...
  // digunakan untuk membuat page nya
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // membuat floating action bottom di tengah
          Align(
  ...
  // memisahkan widget bottom navbar
...
// membuat cliper atau bolongan di tengah botto navigation bar
class BottomNavBArClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(size.width / 2 + 23, 33, size.width / 2 + 28, 0);
