...
class _SelectSchedulePageState extends State<SelectSchedulePage> {
  // HARI YANG AKAN DI TAMPILKAN ADALAH HANYA SEMINGGU
  // TAPI JIKA INGIN MENYIMPANNYA DI FIREBASE BISA TAPI AGAK RIBET
  ...
  Column generateTimeTable() {
    ...
    for (var theater in dummyTheaters) {
      // membuat namanya dengan widgets dengan memanggil class name yang sudah di buat
      widgets.add(
        Container(
